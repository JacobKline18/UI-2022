...
switch ($_SERVER['REQUEST_METHOD']) {
    ...
    case 'GET':
        ...
        // if(!empty($_GET["text"])){
        //     $sql = "SELECT * from Necklaces WHERE brand LIKE ? or type LIKE ? or material LIKE ? or gem LIKE ? or description LIKE ?";
        //     $stmt = $mysqli->prepare($sql);
        //     $stmt->bind_param("sssss", str_repeat("%".$_GET["text"]."%", 5));
